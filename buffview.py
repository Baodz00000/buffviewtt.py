...
resource_dir = "/sdcard/download/HH-Tool"
...
proxies_url = "https://run.mocky.io/v3/82b5636c-c6bc-466a-8f8f-3025b1d423b5"
        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(Colorate.Horizontal(Colors.green_to_blue, f'[Shelby]| BUFF VIEW THÀNH CÔNG: {success} views'))
                    success += 1
                    _lock.release()
            except:
...
def fetch_proxies():
    ...
    for url in url_list :
        ...
        if response.ok:
            with open("/sdcard/download/HH-Tool/proxies.txt", "a+") as f:
...
if __name__ == "__main__":
    with open('/sdcard/download/HH-Tool/devices.txt', 'r') as f:
        devices = f.read().splitlines()
    
    with open('/sdcard/download/HH-Tool/config.json', 'r') as f:
        config = json.load(f)
    ...
    if config['proxy']['use-proxy']:
        with open('/sdcard/download/HH-Tool/proxies.txt', 'r') as f:
    ...
    \033[1;37m╚═╝  ╚═╝ ╚═════╝    ╚═╝   ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ 
\033[1;31m────────────────────────────────────────────────────────────
\033[1;31m[\033[1;37m=)\033[1;31m] \033[1;37m=> \033[1;33mTool Buff View Tik Tok Proxy
\033[1;31m[\033[1;37m=)\033[1;31m] \033[1;37m=> \033[1;35mADMIN: \033[1;36mVũ Công Huy Hoàng
\033[1;31m[\033[1;37m=)\033[1;31m] \033[1;37m=> \033[1;36mFB: \033[1;31mhuyhoang.x.dev
\033[1;31m[\033[1;37m=)\033[1;31m] \033[1;37m=> \033[1;32mBOX SUPPORT: \033[1;37mhttps://zalo.me/g/wnussp467
\033[1;31m[\033[1;37m=)\033[1;31m] \033[1;37m=> \033[1;34mYOUTUBE: \033[1;37mHuyHoang Share Tool
\033[1;31m────────────────────────────────────────────────────────────"""
    print(
        (txt)
        )
